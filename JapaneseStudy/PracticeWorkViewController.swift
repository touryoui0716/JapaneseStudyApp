...
class PracticeWorkViewController: UIViewController {
    ...
    var questionData = [
        ["mondai": "問題(1) お客様(    )商売だから、お客様を何より大切にしなければならない。", "answerA": "(A)  あるの　", "answerB": "(B)  あったの", "answerC": "(C)  のあって", "answerD": "(D)  あっての", "seikai": "(D)  あっての"],
    ...
    override func viewDidLoad() {
        ...
        if numberOfPractice == 0 {
            if partion == 0 {
                ...
                questionData = [
                    ["mondai": "問題(1) 連休中旅行に(          )、連休明けにはレポートを提出しなければならない。", "answerA": "(A)  行こうと行くまいが", "answerB": "(B)  行こうとも", "answerC": "(C)  行こうが行くまいが", "answerD": "(D)  行こうか行くまいか", "seikai": "(C)  行こうが行くまいが"],
