...
class IntroduceViewController: UIViewController {
    ...
    @IBAction func buttonSetsuzoku(_ sender: Any) {
        label2.text = grammarDetail[grammarTitle.0]?[0]
        
        
//        let object : NCMBObject = NCMBObject(className: "Button")
//        // オブジェクトに値を設定
//        object["message"] = "Hello, NCMB!"
//        object["rennshuu"] = "Hello, NCMB!"
//        // データストアへの登録
//        let test = object.save()
       
        
    }
    
    @IBAction func buttonImi(_ sender: Any) {
        label3.text = grammarDetail[grammarTitle.0]?[1]
    }
    
    @IBAction func buttonReibun(_ sender: Any) {
        label4.text = grammarDetail[grammarTitle.0]?[2]
    }
